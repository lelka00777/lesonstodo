...
function App():JSX.Element{
    ...
    const chengeTodoFilter=(filter:FilterValueType) => {  //5 -  фильтрация //  функция которая скажет реакту что нужна перерисовка вешается на кнопку 
...
//   console.log(neWTask)
   ...
   if(filter === 'All'){              // 4 - фильтрация логика фильтра
